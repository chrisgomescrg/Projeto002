...
<head>
    <meta charset="UTF-8">
    <title>Cadastrar Paciente - Projeto 2</title>
    <style>
        :root {
            --primary: #4a90e2;
            --secondary: #f5f7fa;
...
<body>
    <div class="form-box">
        ...
        <form method="post" action="/projeto02/public/index.php?controller=Pacientes&action=create" oninput="validarFormulario()">
            ...
            <input type="text" name="telefone" id="telefone" placeholder="(DDD) 00000-0000" required>
